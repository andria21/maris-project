    ...
    <MotionWrapper>
      <div className="w-full flex flex-col">
        ...
        <section className="flex flex-col justify-between md:gap-16 gap-8">
          <div className="md:grid md:grid-cols-2 flex flex-col-reverse place-content-center items-center justify-center text-center pt-20 md:gap-0 gap-8">
            <Image
              src={
                "https://images.unsplash.com/photo-1618219740975-d40978bb7378?q=80&w=1400&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              }
              width={10000}
              height={10000}
              alt="Blog Image"
            ...
            <p className="px-18 text-gray-300">
              ...
              Distinctio laudantium fuga excepturi possimus temporibus eius esse
              numquam praesentium debitis? Eius veritatis officiis earum velit
              quidem, aliquid neque facilis quis suscipit?
            </p>
          </div>
          <div className="grid md:grid-cols-2 grid-cols-1 place-content-center items-center justify-center text-center pt-20 pb-40 md:gap-0 gap-8">
            <p className="px-18 text-gray-300">
